	...
	public void sendSimpleEmail(QnaFormRequestDto qnaFormRequestDto) {
		MimeMessagePreparator preparatory = mimeMessage -> {
			...
			String content = "<!DOCTYPE html>\r\n"
					...
					+ "                <input type=\"text\" id=\"username\" name=\"username\" placeholder=\"Name\" readonly value=\""
					+ qnaFormRequestDto.getUsername() + "\" style=\"font-size: 15px;\r\n"
					+ "            color: #222222;\r\n"
					+ "            width: 500px;\r\n"
					+ "            border: none;\r\n"
					...
					+ qnaFormRequestDto.getEmail() + "\" style=\"font-size: 15px;\r\n"
					+ "            color: #222222;\r\n"
					+ "            width: 500px;\r\n"
					+ "            border: none;\r\n"
					+ "            border-bottom: solid #aaaaaa 1px;\r\n"
					...
					+ "                <input type=\"text\" id=\"phone\" name=\"phoneNumber\" placeholder=\"Phone Number\" readonly value=\""
					+ qnaFormRequestDto.getPhoneNumber() + "\" style=\"font-size: 15px;\r\n"
					+ "            color: #222222;\r\n"
					+ "            width: 500px;\r\n"
					+ "            border: none;\r\n"
					+ "            border-bottom: solid #aaaaaa 1px;\r\n"
					...
					+ qnaFormRequestDto.getTitle() + "\" readonly style=\"font-size: 15px;\r\n"
					+ "            color: #222222;\r\n"
					+ "            width: 500px;\r\n"
					+ "            border: none;\r\n"
					+ "            border-bottom: solid #aaaaaa 1px;\r\n"
	...
	public void sendAnswerEmail(QnaAnswerMailResponseDto qnaAnswerMailResponseDto) {
		MimeMessagePreparator preparatory = mimeMessage -> {
			...
			String content = "<!DOCTYPE html>\r\n"
					...
					+ "            margin-bottom: 20px;\">&#51228;&#47785;</label>\r\n"
					+ "                <input type=\"text\" id=\"title\" name=\"title\" placeholder=\"Title\" value=\""
					+ qnaAnswerMailResponseDto.getTitle() + "\" readonly style=\"font-size: 15px;\r\n"
					+ "            color: #222222;\r\n"
					+ "            width: 500px;\r\n"
					+ "            border: none;\r\n"
					+ "            border-bottom: solid #aaaaaa 1px;\r\n"
