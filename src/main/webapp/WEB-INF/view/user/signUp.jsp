		...
		<form action="/user/signUp" method="post" autocomplete="off">
			...
			<div id="agree">
				...
				<div>
					...
					<label for="check1">cuggishop가 본인의 개인 정보를 수집 및 이용하는 것에 동의합니다.*</label>
				</div>
				<br>
				<div>
					<input type="checkbox" id="check2" name="check2" >
					<label for="check2">cuggishop가 본인의 개인 정보를 제3자 제공 및 국외 이전 하는 것에 동의합니다.*</label>
				</div>
				<br>
				<div>
					<input type="checkbox" id="check3" name="check3" >
					<label for="check3">cuggishop의 새로운 활동, 전용 상품, 맞춤형 서비스에 대한 맞춤화된 소식과 최신 정보를 받는 것과, 본인의 관심사에 기반한 맞춤화된 서비스를 제공받는 것에 동의합니다.</label>
				</div>
				<br>
				<div>«프로필 만들기»를 선택함으로써, 귀하는 당사의 이용약관에 동의하고, 당사의 개인정보 보호정책을 확인했으며,
					...
					동의하지 않는 경우, cuggishop의 상품과 서비스를 제공 받지 못할 수 있습니다.</div>
				<br>
				<details>
					<summary>자세히 보기</summary>
						<li>해당 문서는 본사의 개인 정보 보호 정책 전문입니다. 본사가 귀하에게 안내하고자 하는 요점은 다음과
							같습니다:</li>
						<li>귀하는 현재 GUCCI 프로필을 생성하고자 하고 있습니다. 이는 cuggishop으로 하여금 귀하에게 개인화되고
							맞춤화된 서비스를 제공하고, 귀하가 cuggishop에 요청하는 상품, 서비스 및 정보를 제공하고 귀하와 소통하는 것을 도울
							것입니다.</li>
						<li>귀하가 신청서에 기입한 모든 개인 정보와 귀하가 판매원 또는 다른 방식(예를 들어 소셜 미디어, 쿠키
							등)을 통해 자발적으로 공유한 다른 개인 정보(이하 “개인 정보”)는 보관 및 사용되고, 귀하의 cuggishop 프로필에
							연결될 것입니다. 귀하의 프로필은 귀하로부터 직접 받은 정보와 함께 본사의 소매점 및 타 상업적 파트너로부터 받은 정보를
							포함할 수 있습니다. 현지 법률에 따라, 본사는 귀하의 개인 정보를 귀하가 cuggishop을 이용하여 소통한 마지막 일시로부터
							...
							있습니다. cuggishop으로부터 온 이메일을 열어보는 것은 마지막 소통에 해당되지 않습니다. 이메일에 포함된 링크를 클릭하는
							것과 본사의 매장에 방문하는 것이 마지막 소통에 해당됩니다.</li>
						<li>본사가 국제적으로 운영되기 때문에, 본사는 귀하의 개인 정보를 cuggishop과 동일한 목적으로, 위에 명기된
							기간 동안 우리 그룹의 기업들과 세계 곳곳에 위치한 승인된 파트너들과 안전하게 공유할 수 있습니다(기업들과 승인된
							파트너들의 리스트는 다음 링크를 참고하시기 바랍니다:
							https://www.cuggishop.com/kr/ko/st/privacy-landing). 본사는 귀하의 개인 정보를
						...
						<li>개인 정보 보호법은 귀하에게 개인 정보 이동권과 더불어 귀하의 데이터에 대한 접근, 삭제, 수정 및 정정,
							...
							권리에 대한 더 많은 정보를 원하시면, privacy@cuggishop.com으로 연락 주시기 바랍니다.</li>
				</details>
			</div>
			<br>
