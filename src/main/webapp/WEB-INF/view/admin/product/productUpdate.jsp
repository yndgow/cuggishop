...
<head>
	...
	<style>
		...
		.updateProduct tr > th:nth-child(1){
			width: 140px;
		}
	</style>
</head>
...
<main>
	...
	<form class="one-table-form ms-4 container" method="POST" action="/admin/product/${adminProductList[0].id}" enctype="multipart/form-data">
		...
		<table class="one-table table table-bordered text-center align-middle updateProduct">
			...
			<tr>
				<th>썸네일<br><button type="button" class="btn btn-dark btnAddImg">추가</button></th>
			...
			<tr>
				<th>세부 이미지<br><button type="button" class="btn btn-dark btnAddImg">추가</button></th>
